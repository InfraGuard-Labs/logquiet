...
Download the latest `.deb` package from the [Releases page](https://github.com/InfraGuard-Labs/logquiet/releases).

### Fedora / RHEL

Download the latest `.rpm` package from the [Releases page](https://github.com/InfraGuard-Labs/logquiet/releases).

### Direct binary

Prebuilt binaries are available for Linux amd64/arm64, macOS Intel/Apple Silicon, and Windows amd64 on the [Releases page](https://github.com/InfraGuard-Labs/logquiet/releases).

`SHA256SUMS.txt` is published alongside each release for checksum verification.
